...
document.querySelector('#landing-section').innerHTML = `
  ...
  <div class="mobile:flex mobile:flex-col">
    <div class="mobile:h-[20.44rem] mobile:w-[20.13rem] mobile:mx-auto mobile:mt-[3rem] mobile:grid mobile:grid-rows-[5rem_13.125rem] mobile:gap-y-[2.7rem] ">
      ...
      <div class=" mobile:flex mobile:flex-col mobile:gap-[1rem]">
        ...
        <p class="font-livvic font-semibold text-[#fff] text-[0.9375rem] leading-[1.75rem] text-center mobile:w-[19rem]">
